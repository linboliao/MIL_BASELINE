...
config=configs/xiehe/CLAM_SB_MIL.yaml
test_dataset_csv=datasets/p-dMMR/test.csv
base_dir=result/p-dMMR/CLAM_SB_MIL/time_2025-11-15-17-51_p-dMMR_CLAM_SB_MIL_seed_42
gpu=0
#cd ../
